#!/usr/bin/env python3
"""
Simple server to run the Evolution of Todo backend with SQLite support and logging
"""
import os
import sys
...
from fastapi import Request  # Add this for logging requests
import logging
...
def update_task_endpoint(
    ...
    """Update an existing task's title in the database."""
    logger.info(f"Updating task {task_id} with title: {task_update.title}")
